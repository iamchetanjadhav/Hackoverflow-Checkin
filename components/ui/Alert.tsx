 ...
 * @description Reusable alert component for success, error, warning, info states
 */
...
const iconMap: Record<AlertVariant, typeof SuccessIcon> = {
  success: SuccessIcon,
  error: ErrorIcon,
  warning: WarningIcon,
  info: InfoIcon,
...
export function Alert({ variant, title, children, className = '' }: AlertProps) {
  ...
  return (
    <div className={`border-l-4 p-4 rounded-r ${styles.container} ${className}`}>
      <div className="flex">
